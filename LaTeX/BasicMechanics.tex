...
\subsection{Standard Action\index{Action!Standard}}\label{subsec:act_standard}
...
\begin{itemize}
	\item tbfi
\end{itemize}
\subsection{Unique Action\index{Action!Unique}}\label{subsec:act_unique} 
\emph{Unique Actions} are difficult Actions that cannot be repeated multiple times per Turn. Unique Actions are as follows:
\begin{itemize}
	\item An END\footnoteref{subsec:end}, depending on the context of the situation.
	\item tbfi
\end{itemize} 
\subsection{Double Action\index{Action!Double}}\label{subsec:act_double} 
...
\begin{itemize}
	...
	\item A POW\footnoteref{subsec:pow} versus one character.
\end{itemize}