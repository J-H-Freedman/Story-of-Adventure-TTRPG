...
\noindent Roll a d100 and add {[}\KNOW{]} as well as the scores of any applicable \skill s\footnoteref{sec:skills}. If your total is above the target threshold then you pass, otherwise you fail.
\fillrlinemid
