...
Details regarding \emph{modifications} for each tech branch, such as applicable areas and effects, can be found in the \emph{Modification Archives}\footnoteref{ch:ref_enhance}
